    ...
    <div class="row mt-4">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
            <div class="main__container bg-white rounded shadow px-2 py-2">
                <h6 class="text-blue-900 font-semibold uppercase">Project Resources</h6>
                <hr class="mt-1">
                ...
                <h6 class="text-blue-900 font-semibold uppercase">Steps to follow in writting project</h6>
                <hr class="mt-1">
                    <p class="">
