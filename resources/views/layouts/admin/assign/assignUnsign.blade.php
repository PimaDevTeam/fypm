                ...
                <div class="col-lg-4">
                    {{-- <a href="{{route('assign.show', $program->id)}}" class="text-decoration-none aSTUD"> --}}
                        <div class="assign__card--container shadow p-10 bg-white">
                            ...
                            <h6 class="text-center text-uppercase mt-4">Assign Supervisor</h6>
                            <div class="flex justify-center mt-4">
                                <a href="{{route('assign.show.groups', $program->id)}}" class="btn btn-primary btn-admin mr-2">Groups</a>
                                <a href="{{route('assign.show', $program->id)}}" class="btn btn-secondary">Students</a>
                            </div>
                        </div>
                    {{-- </a> --}}
                </div>
                <div class="col-lg-4">
                    {{-- <a href="{{route('assign.unassign', $program->id)}}" class="text-decoration-none aSTUD"> --}}
                        <div class="assign__card--container shadow p-10 bg-white">
                            ...
                            <h6 class="text-center text-uppercase mt-4">Unassign Supervisor to</h6>
                            <div class="flex justify-center mt-4">
                                <a href="{{route('assign.unassign', $program->id)}}" class="btn btn-primary btn-admin mr-2">Students</a>
                            </div>
                        </div>
                    {{-- </a> --}}
                </div>
