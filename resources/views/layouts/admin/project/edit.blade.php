        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('project.update', $project->id)}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="topic" value="{{$project->name}}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    @php
                        $selectedValue = $project->project_program_id;
                    @endphp
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                @if ($role)
                                    <select name="program_id" class="form-control" id="">
                                        ...
                                        @foreach ($programs as $program)
                                            ...
                                            <option value="{{$program->id}}" {{ $selectedValue == $program->id ? 'selected="selected"' : '' }} >{{$program->program}}</option>
                                        @endforeach
                                    </select>
                                @else
                                    <input type="hidden" class="form-control" name="program_id" value="{{auth()->user()->progam_id}}">
                                    <input type="text" class="form-control" value="{{$program->program}}">
                                @endif
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="project_description" class="form-control" id="" cols="30" rows="10">
